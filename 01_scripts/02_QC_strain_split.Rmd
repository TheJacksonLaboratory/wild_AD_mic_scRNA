...
```{r , fig.width=3.5, fig.height=4.5}
cd11b.integrated <- readRDS("~/code/2019_04_scRNA_CD11b/emase_2/output/Integration/cd11b_integrated_r2.rds")
...
in_path <- "../raw_data-paper/00_overall_QC_strain_split/all_TPMs.xls"
out_path <- "../output-paper/00_overall_QC_strain_split/"
...
```{r}
source("~/code/2019_04_scRNA_CD11b/functions/my_GLM.R")
